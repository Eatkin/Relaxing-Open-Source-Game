...
//Scrolling
//Literally identical to the collection menu holder
...
if (time==1 and !obj_menuManager.menusActive and obj_menuManager.currentMenu==Menu.Shop)	{
	obj_menuManager.menusActive=true;
	//This says collections but it actually just unloads children
