...
pages=ceil(gridHeight/4)+1;				//Re-define pages
var numButtons=0;
for (var i=0; i<gridHeight; i+=1)	{
	...
	var button=instance_create_layer(x+buttonXOffset,yy+24+53*imod,layer,par_shopButton);
	button.name=grid[# ShopContainer.Name, i];
	button.gridRef=grid[# ShopContainer.Reference, i];
	child[i]=button;
